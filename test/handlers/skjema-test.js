...
tap.equal(Object.keys(skjemaHandlers).length, 11, 'There are 11 skjema handlers')
...
tap.ok(skjemaHandlers.showAlternativtBosted, 'Handler has method showAlternativtBosted')
